+(function () {
  ...
  function n(e, t, i) {
    for (; (e = e.offsetParent); ) if (x(e, t) === i) return !0;
    return !1;
  }
  var a = (function () {
      function e(e, t) {
    ...
    k = (function (o) {
      function r(i, n) {
        return (
          e(this, r),
          t(this, (r.__proto__ || Object.getPrototypeOf(r)).call(this, r, i, n))
        );
      }
      return (
        i(r, o),
        ...
        a(r, [
          {
            ...
            value: function () {
              this.attrNormalize(),
                this.set.range > 0 &&
                  ((this.positionX = l() * this.cw),
                  (this.positionY = l() * this.ch),
          ...
          },
          {
            ...
            value: function () {
              ...
              e.forEach(function (a, o) {
                for (
                  var r = a.x + a.parallaxOffsetX,
                    s = a.y + a.parallaxOffsetY,
                    l = function () {
                      var n = e[o],
              ...
              this.dots.forEach(function (o) {
                if (!e) {
                  if (r) {
                    ...
                    (o.parallaxOffsetX += (t / l - o.parallaxOffsetX) / 10),
                      (o.parallaxOffsetY += (i / l - o.parallaxOffsetY) / 10);
                  }
                  (o.x += o.vx), (o.y += o.vy);
                  var c = o.x,
                    u = o.y,
          ...
          },
          {
            ...
            value: function () {
              return (this.elemOffset =
                this.set.eventElem === document ? null : d(this.set.eventElem));
            },
          },
          {
            key: "proxyEvent",
            value: function (e, t) {
              ...
              E &&
                ((o = function (e) {
                  i.paused ||
                    b(e.beta) ||
                    t(Math.min(Math.max(e.beta, -90), 90), e.gamma);
                }),
